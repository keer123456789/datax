package com.alibaba.datax.plugin.reader.odpsjdbcreader;
...
public class OdpsJdbcReader extends Reader {
    private static final DataBaseType DATABASE_TYPE = DataBaseType.ODPS;
