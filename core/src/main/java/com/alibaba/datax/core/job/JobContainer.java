...
public class JobContainer extends AbstractContainer {
    ...
    @Override
    public Map start(Map dataxResult) {
    ...
    private Map logStatistics(Map resultMsg) {
        long totalCosts = (this.endTimeStamp - this.startTimeStamp) / 1000;
        long transferCosts = (this.endTransferTimeStamp - this.startTransferTimeStamp) / 1000;
        if (0L == transferCosts) {
            transferCosts = 1L;
        ...
        resultMsg.put("startTimeStamp", startTimeStamp);
        resultMsg.put("endTimeStamp", endTimeStamp);
        ...
        resultMsg.put("transformerSucceedRecords", communication.getLongCounter(CommunicationTool.TRANSFORMER_FILTER_RECORDS));
        resultMsg.put("transformerFailedRecords", communication.getLongCounter(CommunicationTool.TRANSFORMER_FAILED_RECORDS));
        resultMsg.put("transformerFilterRecords", communication.getLongCounter(CommunicationTool.TRANSFORMER_FILTER_RECORDS));
        resultMsg.put("readSucceedBytes", communication.getLongCounter(CommunicationTool.READ_SUCCEED_BYTES));
        resultMsg.put("endTransferTimeStamp", this.endTransferTimeStamp);
        resultMsg.put("startTransferTimeStamp", this.startTransferTimeStamp);
        resultMsg.put("transferCosts", transferCosts);
